...
interface Stats {
  ...
  daily_validated_requests_with_responses: number;
}
...
export default function ClientPage({ stats }: ClientPageProps) {
  ...
  const formattedData = (stats ?? []).map((s) => ({
    ...
    daily_validated_requests_with_responses:
      typeof s.daily_validated_requests_with_responses === "number"
          ...
          <div className="mx-auto max-w-2xl lg:max-w-none">
            ...
            <dl className="mt-12 flex flex-col space-y-4 text-center sm:flex-row sm:justify-between sm:gap-4 sm:space-y-0">
              ...
              >
                ...
                >
                  {stats && Number(stats[stats.length - 1]?.wps).toFixed(2)}
                </dd>
              </button>
              ...
              >
                ...
                >
                  {stats &&
                    Number(
                      stats[stats.length - 1]?.time_for_all_tokens,
                    ).toFixed(2)}
                </dd>
              </button>
